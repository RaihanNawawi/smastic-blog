...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Okt 2024 pada 17.12
...
(201, 113, 7, 'like', '2024-10-25 15:08:27'),
(202, 113, 7, 'save', '2024-10-25 15:08:29'),
(203, 114, 1, 'like', '2024-10-25 15:09:00'),
(204, 114, 1, 'save', '2024-10-25 15:09:01'),
(205, 113, 1, 'like', '2024-10-25 15:10:27'),
(206, 113, 1, 'save', '2024-10-25 15:10:28');
...
--
-- Struktur dari tabel `text_snippets`
--
...
--
-- Dumping data untuk tabel `text_snippets`
--
...
`text_content
`) VALUES
(1, 'Selamat Datang Di Website Blog Resmi SMA Sains Tahfizh Siak'),
(3, 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quisquam sunt architecto eveniet cum nemo molestiae, accusantium consequuntur, excepturi atque possimus ad non fugiat esse ratione, repudiandae quod dignissimos natus in!');
...
(1, 'Admin', 'adminphp@gmail.com', '$2y$10$Oj0PgBP02aq1dYNBXEGDhezfGLmFM2IAqVxO/OiEvyJ7dC5cxHpV.', '2024-10-25 14:16:48'),
(2, 'admin2', 'adminphp2@gmail.com', '1234', '2024-10-20 13:35:40'),
(3, 'rehan', 'raihannawawi@gmail.com', '$2y$10$JjOLL5mmlWwFRLdVeLg9mOIbW4AyKuxix5EQZZPcBeDfw86VPQI0O', '2024-10-22 09:27:09'),
(4, 'saki', 'sakinawawi@gmail.com', '$2y$10$qMcaI84/XKKwZYFdQvrJHuZ1SeP3CqovxqtkG3TiGZ5Poekqdxj4.', '2024-10-22 09:29:21'),
(5, 'osk', 'neskyaja@gmail.com', '$2y$10$RlSmMNyJqjfu7WDAUrx/EeJ9F9PcWz7xWavZeuYeL5b2n1PD7Uq7i', '2024-10-22 09:37:08'),
(6, 'admin', 'adminblog@gmail.com', '$2y$10$G9Sh4NRBs0cCg4yPEDQJJuEmLPD0P3q5QbDfHP.99SxR.yfXIrD.y', '2024-10-22 09:46:17'),
(7, 'rehann', 'raihannawawi444@gmail.com', '$2y$10$GGoF4bHRzelYTRP4csIlLuyx60Uqd.EkOBh1LiznzsWDCrdvJ8W/y', '2024-10-22 23:45:31'),
(8, 'admin1234567', 'admin123@gmail.com', '1234567', '2024-10-22 19:31:29'),
(10, 'user1', 'user123@gmail.com', '$2y$10$HcmxITwIJk5IsCkoKpw4Z.gQtI/cRYc85uSHVPxidIpP5IbUodrWm', '2024-10-24 01:06:10'),
(12, 'Mirza ahmad fauzi', 'rakman01@gmail.com', '$2y$10$CjpGEIsle7DbfTx9Ys5kmuIUV7qEfncP4r/vHz0XDW1GYi7vHRKbO', '2024-10-25 01:16:27');
...
--
-- Indeks untuk tabel `text_snippets`
--
...
ALTER TABLE `interactions`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=207;
...
ALTER TABLE `posts`
  MODIFY `id_post` int
(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
...
ALTER TABLE `tags`
  MODIFY `id` int
(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT untuk tabel `text_snippets`
--
ALTER TABLE `text_snippets`
  MODIFY `id` int
